...
export const swaggerConfig = new DocumentBuilder()
  ...
  .setDescription(`${configVariables.database.name} Swagger For API Documentation`)
  .setVersion(configVariables.api.version)
  .addServer(`http://localhost:${configVariables.port}/`, `${configVariables.database.name} Local environment`)
